...
GITHUB_USER="Dillonzellis" # Replace with your GitHub username
REPO_NAME="dotfiles"       # Replace with your repo name
...
install_brew_packages() {
  if [ -f "$HOME/Brewfile" ] && command_exists brew; then
    ...
    if [ ! -f "$HOME/Brewfile" ]; then
      print_info "No Brewfile found, skipping package installation"
...
main() {
  ...
  print_info "To update dotfiles in the future, run: cd ~/dotfiles && git pull"
  echo
}
